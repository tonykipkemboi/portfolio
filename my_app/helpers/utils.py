...
def load_css():
    with open("/my_app/helpers/style.css") as f:
...
def st_button(icon, url, label, iconsize):
    if icon == 'youtube':
        ...
        <p>
            <a href={url} class="btn btn-outline-primary btn-lg btn-block" type="button" aria-pressed="true">
                <svg xmlns="http://www.w3.org/2000/svg" width={iconsize} height={iconsize} fill="currentColor" class="bi bi-hashnode" viewBox="0 0 16 16">
